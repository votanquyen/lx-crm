                ...
                <Card className="border-l-4 border-l-blue-500">
                    ...
                    <CardContent className="space-y-3">
                        <div className="flex items-center justify-between">
                            ...
                            <span className={`text-sm font-black ${totalDebt > 0 ? "text-rose-600" : "text-emerald-600"}`}>
                                {formatCurrency(totalDebt)}
                            </span>
                        </div>
                        {overdueCount > 0 && (
                            <div className="flex items-center justify-between">
                                <span className="text-xs text-muted-foreground">Hóa đơn quá hạn</span>
                ...
                <Card>
                    ...
                    <CardContent>
                        {recentInvoices.length === 0 ? (
                            <p className="text-sm text-muted-foreground text-center py-4">Chưa có hóa đơn</p>
                        ) : (
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <ExternalLink className="h-3 w-3 text-slate-300 group-hover:text-primary transition-colors opacity-0 group-hover:opacity-100" />
                                            </div>
                                        </Link>
                                    );
                                })}
