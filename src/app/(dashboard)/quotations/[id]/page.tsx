    ...
    <div className="container mx-auto max-w-5xl space-y-6 py-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div>
              <p className="text-sm text-muted-foreground">Hạn hiệu lực</p>
              <p className="flex items-center gap-2 font-medium">
                <Calendar className="h-4 w-4" />
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {quotation.items.length} sản phẩm trong báo giá
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="space-y-2">
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">
                {formatCurrencyDecimal(quotation.subtotal)}
              </span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="font-medium">
                {formatCurrencyDecimal(quotation.vatAmount)}
              </span>
            </div>
            <Separator />
              ...
              {quotation.status === "ACCEPTED" && quotation.responseDate && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {format(
                        new Date(quotation.responseDate),
                        "dd/MM/yyyy HH:mm",
                        { locale: vi }
                      )}
                    </p>
