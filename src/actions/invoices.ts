 ...
 */
export const linkSmartvasToInvoice = createAction(linkSmartvasSchema, async (input) => {
 ...
 */
export const updatePaymentDate = createAction(updatePaymentDateSchema, async (input) => {
  const session = await requireAccountant();
